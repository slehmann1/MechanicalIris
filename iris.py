...
class Iris:
    ...
    def __init__(self, blade_count, a, b, c, d, e, f, g, theta_5) -> None:
...
iris = Iris(16, 66.5, 42, 39.5, 36.5, 41.5, 35, 72, 60 * np.pi / 180)
iris.animateIris(200 * np.pi / 180, 230 * np.pi / 180)
